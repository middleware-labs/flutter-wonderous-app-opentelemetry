                ...
                if (data.culture.isNotEmpty) ...[
                  Text(
                    ...
                    style: $styles.text.titleFont
                      ...
                      .maybeAnimate()
                      .fade(delay: 150.delayMs, duration: 600.animateMs),
                ...
                Semantics(
                  ...
                  child: Text(
                    ...
                    overflow: TextOverflow.ellipsis,
                      ...
                      .maybeAnimate()
                      .fade(delay: 250.delayMs, duration: 600.animateMs),
                ),
                ...
                Column(
                  ...
                  children: [
                    ...[
                      ...
                      _InfoRow(
                          $strings.artifactDetailsLabelPeriod, data.period),
                      _InfoRow(
                          $strings.artifactDetailsLabelGeography, data.country),
                      _InfoRow(
                          $strings.artifactDetailsLabelMedium, data.medium),
                      _InfoRow($strings.artifactDetailsLabelDimension,
                          data.dimension),
