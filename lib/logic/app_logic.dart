...
class AppLogic {
  ...
  void precacheWonderImages(BuildContext context) {
    debugPrint(
        'Skipping precache, need to figure out why it\'s not working on web.');
    return;
    precacheImage(AssetImage('images/chichen_itza/chichen.png'), context);
    precacheImage(
        AssetImage('images/chichen_itza/foreground-left.png'), context);
    precacheImage(
        AssetImage('images/chichen_itza/foreground-right.png'), context);

    precacheImage(
        AssetImage('images/christ_the_redeemer/redeemer.png'), context);
    precacheImage(
        AssetImage('images/christ_the_redeemer/foreground-left.png'), context);
    precacheImage(
        AssetImage('images/christ_the_redeemer/foreground-right.png'), context);
    ...
    precacheImage(
        AssetImage('images/great_wall_of_china/great-wall.png'), context);
    precacheImage(
        AssetImage('images/great_wall_of_china/foreground-left.png'), context);
    precacheImage(
        AssetImage('images/great_wall_of_china/foreground-right.png'), context);

    precacheImage(AssetImage('images/machu_picchu/machu-picchu.png'), context);
    precacheImage(
        AssetImage('images/machu_picchu/foreground-back.png'), context);
    precacheImage(
        AssetImage('images/machu_picchu/foreground-front.png'), context);
